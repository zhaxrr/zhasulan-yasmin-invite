...
const translations = {
    ...
    kz: {
        ...
        storyText: "Бәрі кездейсоқ кездесуден басталып, өмірімізді мәңгілікке өзгертті.",
        celebrationTitle: "Салтанатты кеш",
        celebrationText: "Сіздерге жайлы және шынайы эмоцияларға толы кешті дайындадық.",
        celebrationTime: "Салтанатты кеш 17:00-де басталады.",
        when: "Қашан", where: "Қайда",
        guestGathering: "17:00 — Қонақтарды қарсы алу",
        regTitle: "Тіркелу",
        regSub: "Қатысуыңызды растауыңызды сұраймыз.",
        labelCount: "Қанша адам келесіздер?",
        opt1: "Өзім келемін", opt2: "Екеуіміз келеміз", opt3: "Үшеуіміз келеміз", opt4: "Төртеуіміз келеміз", opt5: "Бесеуіміз келеміз",
        submitBtn: "Растау",
        guestNamePlaceholder: "Қонақтың аты-жөні",
        alertSuccess: "Қатысуыңыз сәтті расталды!",
        alertError: "Жіберу кезінде қате кетті. Қайтадан көріңіз.",
        labelPhone: "Байланыс телефоны",
        phonePlaceholder: "+7 (___) ___-__-__",
        kidTitle: "Өте маңызды",
        kidText: "Құрметті қонақтар! Осы кеште сіздердің толықтай демалып, мерекенің қызығын тамашалағандарыңызды қалаймыз. Кеш бағдарламасы ересектерге арналғандықтан, мерекеге баласыз келулеріңізді сұраймыз. Түсіністік танытқандарыңыз үшін алғыс білдіреміз!",
        august: "Тамыз 2026",
        joinGroup: "Топқа қосылу",
        groupTitle: "Тойдың видео және фотосуреттер тобы",
        groupInfo: "Осы топқа қосылуларыңызды және тойдан естелік видео-фотоларыңызды мұнда бөлісулеріңізді сұраймыз!",
        geoTitle: "Өтетін жер",
        geoInfo: "Ақтөбе қ., Бөкенбай батыр көш., 40г Банкетный зал \"Elegant Hall\"",
        geoBtn: "2ГИС қарау",
        groupcheerTitle: "Сіздің видео құттықтауыңыз үшін топ",
        groupcheerInfo: "Бұл топқа қосылып, видеоларыңызды сонда бөлісіңіздер! Біз сіздердің жылы сөздеріңізді және тілектеріңізді көруге қуаныштымыз.",
        hostsSubtitle: "Тойдың иелері",
        restaurantname: "\"Elegant Hall\" банкет мейрамханасы",
        restaurantaddress: "Ақтөбе қ., Бөкенбай батыр көшесі, 40ғ",
